...
class Management2 extends Component {
        ...
        return data?.map((item, index) => {
            return <>
                <tr className="border-b border-gray-200 hover:bg-gray-100">
                    ...
                    <td className="py-3 px-6 text-left whitespace-nowrap" key={index}>
                                            ...
                                            <div className="p-1">
                                                <div className="overflow-x-auto">
                                                    <table className="table-auto w-full">
                                                        ...
                                                        {/* <ProjectUsers item={item} projectId={item.id} /> */}
                                                        {item?.members.map((mem, index) => {
                                                            return <ProjectUsers item={mem} key={index} projectId={item.id} />
                                                        })}
                                                    </table>
                                                </div>
                                            </div>
                    ...
                    <td className="py-3 px-6 text-center">
                        <div className="flex item-center justify-center">
                            ...
                            <div className="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" onClick={() => this.props.deleteProject(item.id)}>
...
const mapDispatchToProps = (dispatch) => {
    return {
        ...
        deleteProject: (id) => {
            dispatch(actions.actDeleteProject(id))
        },
    }
}
